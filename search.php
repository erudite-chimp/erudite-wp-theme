<?php get_header(); ?>
			...
			<div id="content" class="clearfix row">
				...
				<div id="main" class="col col-sm-7 col-sm-offset-1 clearfix" role="main">

					<div class="page-header"><h1><span><?php _e("Search Results","wpbootstrap"); ?> -</span> <?php echo esc_attr(get_search_query()); ?></h1></div>
